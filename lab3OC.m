%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is the combination of the two optimizations.
% Please make sure that findGoodPlaintexts has been run before running
% this. It only needs to be run once, so if it was run previously and the
% goodTraces directory has not been emptied or deleted than it does not
% need to be run again.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

disp('Running both optimizations');
